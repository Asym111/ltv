...
# ═══════════════════════════════════════════════════════════════
# Строго ПОСЛЕ create_all и миграций: задачи ходят в базу, и регистрация
# их раньше создания таблиц — мина на случай, если у задачи однажды
# окажется первый запуск сразу при старте, а не через интервал.
start_scheduler()
